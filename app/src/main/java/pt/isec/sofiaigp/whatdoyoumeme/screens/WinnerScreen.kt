...
@Composable
fun WinnerScreen(navController: NavHostController, viewModel: GameViewModel) {
    val gameRoom = GameRoom(roomName = "test", players = listOf("Sofia", "Maria", "Dani", "Pepe", "Tino", "Docinho"), maxPlayers = 3, currentNumPlayers = 3, winner = "Maria")
    /*TODO receive gameRoom as a parameter*/
    Column (
        ...
        Column(
            ...
            LazyColumn (
                ...
                items(gameRoom.players!!){player ->
                    if(player != gameRoom.winner){
                        Text(
                            text = player + " = score", /*TODO get player name instead of id and score*/
